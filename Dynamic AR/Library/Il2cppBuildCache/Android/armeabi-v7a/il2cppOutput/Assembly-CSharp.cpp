...
IL_000f:
		{
			...
			Vector3__ctor_m57495F692C6CE1CEF278CAD9A98221165D37E636_inline((&L_4), (-0.0599999987f), (0.100000001f), (-0.0199999996f), /*hidden argument*/NULL);
			NullCheck(L_3);
...
IL_0034:
		{
			// foreach (var trackedImage in eventArgs.added)
			bool L_5;
			L_5 = Enumerator_MoveNext_m89255A16DAE894CEA174A88A674162B09592C8C7((Enumerator_t38DCEDBB06600CDABFF1967A5F011738638CE8F4 *)(&V_0), /*hidden argument*/Enumerator_MoveNext_m89255A16DAE894CEA174A88A674162B09592C8C7_RuntimeMethod_var);
			if (L_5)
			{
				goto IL_000f;
			}
